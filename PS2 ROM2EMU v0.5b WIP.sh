...
# SP193_NFO:
#
# ROM0	BOOT ROM	Boot ROM.
# ROM1	DVD ROM		Contains EROMDRV, which allows access to the encrypted erom device.
# ROM2	DVD ROM		Contains the Chinese font. Only exists on Chinese consoles.
# EROM	DVD ROM		Contains the DVD player.
# NVM	NVM		Contains OSD settings, calibration data for the CD/DVD drive, system settings (e.g. tray eject speed and system fan speed) and IDs (console and i.Link, plus MAC address).
# MEC	?		Contain the MECHACON version data.


# SCPH-30003R (0160EC20010704)
# SCPH-30004R (0160EC20010704)
#	ROM1	0x00000000 0x0003FFFF (40000)
#	ROM2	0x00000000 0x0003FFFF (40000)
#	EROM	0x00040000 0x001FFFFF (1C0000)

# SCPH-50003 (0170EC20030227)
# SCPH-75003 (0220EC20050620)
# SCPH-77003 (0220EC20060210)
#	ROM1	0x00000000 0x0007FFFF (80000)
#	ROM2	0x00000000 0x0007FFFF (80000)
#	EROM	0x00100000 0x0037FFFF (300000) << skąd ta luka na aż 20000h?
